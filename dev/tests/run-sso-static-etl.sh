...
SPARK_APP_PATH="target/scala-2.11/spark-etl-assembly-1.2.jar"
SPARK_APP_URL="hdfs://nameservice-01/user/spark/app/spark-etl-assembly-1.2.jar"

SPARK_ARGS="
    --class com.hcdlearning.recipes.SSOStaticLoading
    --name ${SPARK_APP_NAME}
    --master ${SPARK_MASTER}
    --deploy-mode cluster
    --driver-cores 1
...
${BASEDIR}/bin/webhdfs/upload.sh ${NAMENODE} "/user/spark/app/spark-etl-assembly-1.2.jar" "${SPARK_APP_PATH}"
